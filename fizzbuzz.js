...
avow('FizzBuzz 4 should be ..Fizz.', '..Fizz.' === FizzBuzz(4), '..Fizz.', FizzBuzz(4));
avow('FizzBuzz 5 should be ..Fizz.Buzz', '..Fizz.Buzz' === FizzBuzz(5), '..Fizz.Buzz', FizzBuzz(5));
avow('FizzBuzz 6 should be ..Fizz.BuzzFizz', '..Fizz.BuzzFizz' === FizzBuzz(6), '..Fizz.BuzzFizz', FizzBuzz(6));
avow('FizzBuzz 7 should be ..Fizz.BuzzFizz.', '..Fizz.BuzzFizz.' === FizzBuzz(7), '..Fizz.BuzzFizz.', FizzBuzz(7));
